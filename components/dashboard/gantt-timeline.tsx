    ...
    <>
      <div className="bg-card border border-border overflow-hidden">
        ...
        <div className="p-4 border-b border-border flex items-center justify-between flex-wrap gap-2">
          <h2 className="text-sm font-medium">Pipeline de Missões</h2>
          ...
          <div className="border-b border-border sticky top-0 bg-card z-10">
            <div className="flex min-w-[800px]">
              <div className="w-48 md:w-64 shrink-0 border-r border-border p-3 bg-card">
                <span className="text-xs font-medium text-muted-foreground">Missão</span>
              </div>
          ...
          <div className="divide-y divide-border">
            ...
            {visibleCampaigns.length === 0 && (
              <div className="p-8 text-center text-muted-foreground">
                <p className="text-sm">Nenhuma missão no período selecionado</p>
              </div>
            )}
          </div>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold">
                  {isEditing ? "Editar Missão" : "Detalhes da Missão"}
                </h2>
              ...
              {isEditing ? (
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="editName">Nome da Missão</Label>
                    <Input
                      id="editName"
                      value={editForm.name}
                  ...
                  <div>
                    <Label htmlFor="editChannel">Fonte / Canal</Label>
                    <select
                      id="editChannel"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="editBudget">Orçamento (R$)</Label>
                      <Input
                        id="editBudget"
                        type="number"
                    ...
                    <div>
                      <Label htmlFor="editProgress">Progresso (%)</Label>
                      <Input
                        id="editProgress"
                        type="number"
                        min="0"
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-surface p-3 border border-border">
                      ...
                      <p className="text-lg font-mono font-semibold">R$ {selectedCampaign.budget.toLocaleString()}</p>
                    </div>
                    <div className="bg-surface p-3 border border-border">
