...
// ShineBorder — magicui component
// Used on FlowCards with status=error to draw attention via animated shine
...
interface ShineBorderProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  duration?: number
  /** Color of the border, can be a single color or an array @default "#000000" */
