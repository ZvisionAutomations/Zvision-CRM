...
const initialCampaigns: Campaign[] = [
  ...
  {
    id: "camp-002",
    name: "Nexus Sistemas Ltda - Expansão",
    status: "live",
    spend: 8920,
    impressions: 456000,
    channel: "Google Ads",
  ...
  {
    id: "camp-003",
    name: "Cobra Digital - Recuperação",
    status: "live",
    spend: 3240,
    impressions: 234000,
    channel: "Meta Ads",
...
export function DashboardProvider({ children }: { children: React.ReactNode }) {
  ...
  const [audienceSegments] = useState<AudienceSegment[]>([
    { id: "seg-001", name: "Key Accounts", size: 45000, growth: 12.5, engagement: 8.2 },
    { id: "seg-002", name: "Leads em Negociação", size: 128000, growth: -3.2, engagement: 4.5 },
    { id: "seg-003", name: "Prospects Frios", size: 892000, growth: 25.8, engagement: 2.1 },
  ])
