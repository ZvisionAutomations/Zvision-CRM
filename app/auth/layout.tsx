    ...
    return (
        <div className="min-h-screen flex font-sans bg-background">
          ...
          `
            ...
            {/* Main content area */}
            <main className="flex-1 flex flex-col border-l border-white/5" style={{ backgroundColor: '#050506', backgroundImage: 'repeating-linear-gradient(rgba(162, 230, 53, 0.03) 0 1px, transparent 1px 40px), repeating-linear-gradient(90deg, rgba(162, 230, 53, 0.03) 0 1px, transparent 1px 40px)' }}>
